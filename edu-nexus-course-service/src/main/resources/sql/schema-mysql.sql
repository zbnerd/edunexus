...
(
    ...
    updated_at    DATETIME     NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '강의 수정 시간',
...
(
    ...
    updated_at DATETIME NULL     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '평가 수정 시간',
